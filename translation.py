...
<b>Send me any Telegram file & reply to that file with <code>/rename</code> FileName.ext</b>
   ...
   @tnmaza_support """
    ...
    UPLOAD_START = "<b>Your Download Completed🥰🥰</b>" \
                   "Support @tnmaza_support"
    RCHD_TG_API_LIMIT = "Your File Downloaded {} seconds.\nDetected File Size: {}\nYou are Killing My Server!!!🥺"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me > Support @tnmaza_support **"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Got Your Files in {} seconds.\nSent to You in {} seconds"
    NOT_AUTH_USER_TEXT = "PM @tnvip_bot"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Got This Msg PM @tnvip_bot"
    ...
    SAVED_RECVD_DOC_FILE = "Just Got Your File, Uploading Soon...😉"
    CUSTOM_CAPTION_UL_FILE = " "
    NO_CUSTOM_THUMB_NAIL_FOUND = "No Thumbnail Saved😓"
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    HELP_USER = """
<b>It's Simple Don't Complicate it.</b>
    Sent Your File Here to this bot
    Sent Thumbnail for the file sent
    Enter your new file name in this format
     i.e, /rename New FileName.ext
<b>Files Supported MP4,MKV,MP3,MOV.... @tnmaza_support </b>"""
